    ...
    return(
        <div className='board'>
            <div className='row'>
                ...
                <Letter letterPos={5} attemptValue={0} />
            </div>
            <div className='row'>
                ...
                <Letter letterPos={5} attemptValue={1} />
            </div>
            <div className='row'>
                ...
                <Letter letterPos={5} attemptValue={2} />
            </div>
            <div className='row'>
                ...
                <Letter letterPos={5} attemptValue={3} />
            </div>
            <div className='row'>
                ...
                <Letter letterPos={5} attemptValue={4} />
            </div>
            <div className='row'>
                ...
                <Letter letterPos={5} attemptValue={5} />
            </div>
        </div>
    )
}
